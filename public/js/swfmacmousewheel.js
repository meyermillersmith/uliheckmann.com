/**
 * SWFMacMouseWheel v1.1: Prevents JavaScript errors when no callback is added in Flash (Thomas Meyer, Less Rain, http://www.blog.lessrain.com/ )
 * 
...
{
	this.so = swfObject;
	this.swfElement = document[ this.so.getAttribute('id') ];
...
SWFMacMouseWheel.prototype = {
	...
	{
		if (this.swfElement.externalMouseEvent) this.swfElement.externalMouseEvent( delta );
	},
