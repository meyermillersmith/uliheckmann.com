...
class com.blitzagency.xray.util.Flashout extends Object
{
	...
	*/
	...
	private static function createSocket():Void
	{
	...
	public static function traceReplacer(message:Object, classMethodString:String, file:String ,line:Number):Void
	{
		var d:Date = new Date();
	...
	public static function test(message:Object):Void
	{
