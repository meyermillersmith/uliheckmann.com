...
/**
 * @author Oliver List, Less Rain (o.list_at_@lessrain.com)
 */
class lessrain.lib.components.mediaplayer07.display.ChunkedVideoPlayerView extends View {
	 ...
	 * @see	View#getType
	 */	
	public static var TYPE : String = "chunkedVideoPlayerView";
	 ...
	 * @see View
	 */
	public function ChunkedVideoPlayerView(mediaPlayer_ : MediaPlayer) {
		super(mediaPlayer_);
	}
	...
	public function buildUI(skinFactory_ : ISkinFactory) : Void {
		...
		// TODO add a method to create individual video and sound objects depending on the number of chunks
